          ...
          return ListView(
            ...
            children: [
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: totalValue <= 0 || mainInvestment == null
                          ? null
                          : () => context.push(
                                '/transfer?from=investment&fromId=${mainInvestment.id}&to=balance',
                              ),
              ...
              if (list.isEmpty) ...[
                ...
                ...list.map(
                  (inv) => _InvestmentCard(investment: inv),
                ),
              ],
            ],
          );
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.trending_up_rounded, color: AppColors.investment),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
